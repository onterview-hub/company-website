...
const services = [
  {
    ...
    description: [
      ...
      "단순 녹화가 아닌, 학습 몰입도를 높이는 시각 자료와 편집 기법을 함께 적용합니다.",
    ],
    features: [
      "스튜디오·현장 촬영 지원",
      "자막 및 그래픽 자료 편집",
      "챕터별 구성 및 목차 삽입",
      "다양한 포맷(온라인 강의, VOD 등) 납품",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "현장 촬영부터 하이라이트 편집까지, 행사 목적에 맞는 최적의 결과물을 제공합니다.",
    ],
    features: [
      "행사 현장 다각도 촬영",
      "하이라이트 및 요약 영상 편집",
  ...
  },
  {
    ...
    description: [
      ...
      "교육적 효과를 높이는 인터뷰 구성과 스토리텔링을 함께 적용합니다.",
    ],
    features: [
      "다큐멘터리형 현장 촬영",
      "참여자 인터뷰 구성",
  ...
  },
  {
    ...
    description: [
      ...
      "유튜브, 자체 플랫폼 등 다양한 채널 송출을 지원하며, 다중 카메라 스위칭도 가능합니다.",
    ],
    features: [
      "다중 카메라 실시간 스위칭",
      "유튜브·자체 플랫폼 동시 송출",
  ...
  },
  {
    ...
    description: [
      ...
      "기획, 시나리오, 캐스팅, 촬영, 편집까지 전 과정을 원스톱으로 제공합니다.",
    ],
    features: [
      "스토리 기획 및 시나리오 작성",
      "캐스팅 및 촬영 진행",
  ...
  },
  {
    ...
    description: [
      ...
      "기획 단계에서부터 브랜드의 톤앤매너를 깊이 이해하고, 이를 영상 전반에 일관되게 반영합니다.",
    ],
    features: [
      "브랜드 스토리 기획",
      "감성적 영상미 연출",
  ...
  },
  {
    ...
    description: [
      ...
      "트렌드를 반영한 편집과 후킹 포인트 설계로 콘텐츠의 확산력을 높입니다.",
    ],
    features: [
      "채널별 맞춤 포맷 기획",
      "숏폼 트렌드 반영 편집",
  ...
  },
  {
    ...
    description: [
      ...
      "정확한 정보 전달과 신뢰감 있는 톤앤매너를 바탕으로 기획합니다.",
    ],
    features: [
      "사내소식·행사 영상 제작",
      "CEO 메시지 영상",
