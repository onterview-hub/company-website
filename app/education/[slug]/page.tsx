...
const services = [
  {
    ...
    description: [
      ...
      "단순 이론 강의가 아니라, 실제 업무에 AI 도구를 적용해보는 실습 중심으로 진행하여 교육 직후 바로 활용할 수 있는 역량을 갖추게 합니다.",
    ],
    features: [
      "생성형 AI 기초 개념 이해",
      "업무별 맞춤 AI 도구 실습",
    ...
    audience: ["일반 임직원", "학생 및 취업준비생", "AI 입문자"],
  },
  {
    slug: "career",
    title: "진로교육",
    ...
    description: [
      ...
      "적성 탐색부터 진로 설계, 목표 수립까지 단계별 프로그램으로 구성되어 있습니다.",
    ],
    features: [
      "자기이해 및 적성 탐색 워크숍",
      "직업군별 정보 탐색 프로그램",
  ...
  },
  {
    ...
    description: [
      ...
      "직무별 맞춤 컨설팅과 모의면접을 통해 실제 채용 현장에서 통하는 역량을 길러드립니다.",
    ],
    features: [
      "이력서·자기소개서 첨삭 컨설팅",
      "직무별 모의면접 및 피드백",
  ...
  },
  {
    ...
    description: [
      ...
      "실제 창업 사례와 시장 데이터를 기반으로 한 실전형 커리큘럼으로 구성되어 있습니다.",
    ],
    features: [
      "비즈니스 모델 설계 워크숍",
      "사업계획서 작성 컨설팅",
    ...
    audience: ["예비 창업자", "초기 스타트업", "창업 동아리"],
  },
  {
    slug: "job-creation",
    title: "창직교육",
  ...
  },
  {
    ...
    description: [
      ...
      "직무교육부터 조직문화, 리더십까지 다양한 주제를 기업의 상황에 맞게 유연하게 구성합니다.",
    ],
    features: [
      "조직 니즈 진단 및 커리큘럼 설계",
      "직무별 맞춤 교육 프로그램",
  ...
  },
  {
    ...
    description: [
      ...
      "직업인 인터뷰, 현장 방문, 실습형 체험 등 다양한 방식으로 프로그램을 구성합니다.",
    ],
    features: [
      "직업인 인터뷰 및 특강",
      "현장 방문 및 체험형 프로그램",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {service.features.map((f) => (
              <div
                key={f}
                className="flex items-center gap-3 border border-white/10 rounded-xl px-5 py-4"
              >
